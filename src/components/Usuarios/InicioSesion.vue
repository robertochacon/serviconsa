    ...
    <section class="hero  is-fullheight fondo">
        ...
        <div class="hero-body">
            <div class="container">
                ...
                <div class="box login" style="width:50%;margin:auto;">
                    <img src="@/assets/logo.png" width="200" style="display: block; margin:0 auto;border-radius:10px;"><br>
                    <h1 class="title is-1 has-text-centered is-family-bold"><span v-if="informacionNegocio">{{ informacionNegocio.nombre }}</span></h1>
                    ...
                    <b-button type="is-dark" size="is-large" icon-left="check" @click="iniciarSesion" expanded>Ingresar</b-button>
                </div>
